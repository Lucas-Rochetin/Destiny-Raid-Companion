...
\subsection{Architecture des composants Next.js}

J'ai choisi Next.js pour le frontend. L'avantage principal : les guides de raids sont rendus côté serveur (SSR), ce qui améliore le SEO et le temps d'affichage initial.
...
|   |   +-- guides/
|   |   |   +-- [raidId]/   # Affichage d'un guide (SSR)
|   |   +-- squads/         # Gestion des escouades
|   +-- api/                # API Routes pour callbacks
...
\textbf{Technologies :} Next, Vite, TailwindCSS, Axios
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{assets/zoning.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/wireframe.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{assets/maquette.png}
