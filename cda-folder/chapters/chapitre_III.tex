...
\textbf{Vos user stories avec estimations et alignement roadmap :}
\begin{longtable}{p{3cm}p{4cm}p{1.5cm}p{1.5cm}p{2cm}}
\toprule
\textbf{User Story} & \textbf{Critères d'acceptation} & \textbf{SP} & \textbf{Sprint} & \textbf{Roadmap} \\
\midrule
...
main (protected) -------------------------------
  |                      |          |
  |                      |          +-- hotfix/api-bungie-fix (urgent)
  |                      |
  +-- develop (protected) ----------------------
       |                    |          |
       |                    |          +-- release/v1.0.0 (pré-production)
       |                    |
...
\textbf{Votre estimation globale :} \textit{Le projet est estimé à 65 jours de travail effectif répartis sur 8 mois (octobre 2025 à mai 2026), incluant 20\% de marge pour les imprévus liés à l'API Bungie. Cette estimation couvre le développement, les tests d'intégration API, et le déploiement.}

\textbf{Estimation détaillée avec justification technique :}
\begin{longtable}{p{3cm}p{2.5cm}p{1.5cm}p{1.5cm}p{2cm}}
\toprule
